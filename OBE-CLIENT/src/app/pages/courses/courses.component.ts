...
export class CoursesComponent implements OnInit {
  ...
  submitForm(form: FormGroup) {
    ...
    if(!this.updation) {
      console.log(this.data.httpHeaders)
      this.httpClient.post<{ response: Course, error: any }>(`${environment.serverUrl}/courses/add-course`,{...courseObj},{headers: this.data.httpHeaders})
        .toPromise()
        .then((value) => {
      ...
      this.httpClient.put<{ response: Course }>(`${environment.serverUrl}/courses/update-course/${courseObj._id}`, { ...courseObj },{headers: this.data.httpHeaders})
        .toPromise()
        .then((value) => {
  ...
  deleteCourse(modalRef: any, id: any) {
    this.modalService.open(modalRef).result.then((value) => {
      this.httpClient.delete(`${environment.serverUrl}/courses/delete-course/${id}`,{headers: this.data.httpHeaders})
      .toPromise()
      .then((value) => {
