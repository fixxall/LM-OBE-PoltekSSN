  ...
  getPdfContent({ courseName, curriculumName, ciaMarks, eseMarks, directAttainment, indirectAttainment, totalAttianment }: {
    ...
    const docRef = pdfMake.createPdf({
      header: (currentPage, pageCount, pageSize) => currentPage === 1 ? [] : [
        { text: 'Politeknik Siber dan Sandi Negara', bold: true, alignment: 'center', fontSize: 12, margin: [0, 7, 0, 0] },
      ...
      content: [
        // Title Page
        { alignment: 'center', text: 'Politeknik Siber dan Sandi Negara', margin: [0, 240, 0, 0], fontSize: 30 },
